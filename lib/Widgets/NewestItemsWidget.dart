                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RatingBar.builder(initialRating: 4, minRating: 1, direction: Axis.horizontal, itemCount: 5, itemSize: 18, itemPadding: EdgeInsets.symmetric(horizontal: 4), itemBuilder: (context, _) => Icon(Icons.star), onRatingUpdate: (index) {} ),
                    ],
                  ),
                ),
                ],
